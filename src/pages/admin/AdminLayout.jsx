...
const navItems = [
  ...
  { to: '/admin/chatbot',       label: 'Chat Bot',      icon: Bot },
  { to: '/admin/email-responder', label: 'Email Responder', icon: Mail },
...
const pageTitles = {
  ...
  '/admin/chatbot':       'Chat Bot',
  '/admin/email-responder': 'Email Responder',
